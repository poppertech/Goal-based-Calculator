...
namespace PoppertechCalculator.Tests
{
    ...
    public class GoalAttainmentCalculatorTests
    {
        ...
        public void CalculateAttainmentProbabilitiesOnSuccessReturnsProbabilities()
        {
            ...
            var investmentContext1 = new InvestmentContext() { Amount = 80, Weight = .4m, TimeSeriesReturns = returns1 };
            var investmentContext2 = new InvestmentContext() {Amount = 120, Weight = .6m, TimeSeriesReturns = returns2 };
